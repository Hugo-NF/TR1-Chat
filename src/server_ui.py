...
class Ui_serverWindow(object):
    def setupUi(self, serverWindow):
        ...
        self.portEdit = QtWidgets.QLineEdit(self.networkFrame)
    ...
    def retranslateUi(self, serverWindow):
        ...
        self.hostEdit.setPlaceholderText(_translate("serverWindow", "127.0.0.1"))
        ...
        self.portEdit.setPlaceholderText(_translate("serverWindow", "8080"))
